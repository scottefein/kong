...
describe("response-transformer header_filter", function()
  describe("execute_headers()", function()
    describe("remove", function()
      ...
      it("should remove an exisiting header from arg #2", function()
        ...
        header_filter.transform_headers(conf, ngx_headers)
        assert.same({}, ngx_headers)
      end)
      it("should set content-length nil", function()
        local ngx_headers = {h1 = "value1", h2 = {"value2a", "value2b"}, ["content-length"] = "100", ["content-type"] = "application/json"}
        header_filter.transform_headers(conf, ngx_headers)
        assert.falsy(ngx_headers["content-length"])
      end)
    end)
    describe("replace", function()
      ...
      it("should replace a header if the header only exists", function()
        ...
        header_filter.transform_headers(conf, req_ngx_headers)
    ...
    describe("add", function()
      ...
      it("should set content-length nil", function()
        local ngx_headers = {h1 = "v1", ["content-length"] = "100", ["content-type"] = "application/json"}
        header_filter.transform_headers(conf, ngx_headers)
        assert.falsy(ngx_headers["content-length"])
      end)
    end)
